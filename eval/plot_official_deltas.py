...
plt.rcParams.update({
    "font.size":13,"axes.labelsize":13,"xtick.labelsize":12,"ytick.labelsize":13,"axes.edgecolor":INK,"axes.labelcolor":INK,
    "text.color":INK,"xtick.color":INK,"ytick.color":INK,
    "axes.spines.top":False,"axes.spines.right":False,"axes.spines.left":False,
    "axes.axisbelow":True,"legend.frameon":False,"savefig.dpi":200,
    "savefig.bbox":"tight","font.family":"DejaVu Sans"})

fig,ax=plt.subplots(figsize=(7.2,4.0)); y=list(range(len(names)))
...
for yi,m,p in zip(y,means,poss):
    ...
    ax.text(m+off,yi,f"{m:+.2f}  ({p}/9)",va="center",ha=ha,fontsize=12,
...
ax.set_xlabel("mean $\\Delta$  (vision-init $-$ baseline, points)",fontsize=13)
